...
const startPresale = async() => {
  try {
    ...
    console.log("startPresale: ", error)
  }
}
...
const checkIfPresaleStarted = async() => {
  try {
    ...
    console.log("checkIfPresaleStarted: ", error)
    return false
  }
}
...
const checkIfPresaleEnded = async() => {
  try {
    ...
    console.log("checkIfPresaleEnded: ", error)
    return false
  }
}
...
const getTokenIdsMinted = async() => {
  try {
    ...
    console.log("getTokenIdsMinted: ", error)
  }
}
...
const getProviderOrSigner = async(needSigner = false) => {
  ...
  if(chainId !== 4) {
    const errorMessage = "Change the netowrk to Rinkeby"
